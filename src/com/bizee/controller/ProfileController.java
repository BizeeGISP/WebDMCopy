...
public class ProfileController
{
	...
	private IprofileService iProfileService;
		...
		public ModelAndView saveProfile(@ModelAttribute("command") ProfileBean profileBean, 
		...
		public ModelAndView addProfile(@ModelAttribute("command")  ProfileBean profileBean,
				BindingResult result) {
			Map<String, Object> model = new HashMap<String, Object>();
			model.put("profiles",  prepareListofBean(iProfileService.profileList()));
		...
		public ModelAndView editStudent(@ModelAttribute("command")  ProfileBean profileBean,
				BindingResult result) {
		...
		public ModelAndView editProfile(@ModelAttribute("command")  ProfileBean profileBean,
				BindingResult result) {
			Map<String, Object> model = new HashMap<String, Object>();
			model.put("profile", prepareProfileBean(iProfileService.getProfile(profileBean.getId())));
			model.put("profiles",  prepareListofBean(iProfileService.profileList()));
			return new ModelAndView("addprofile", model);
		}
